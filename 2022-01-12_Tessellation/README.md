...
This piece is a homage to [Research Remora]() whose shattered
tessellations I’ve long admired. I have not been able to figure out how
he gets that awesome effect of shattering. Here, I take a Voronoi
tessellation and smash it with a recursive L-system that I lifted from
[Fronkonstin]().
...
coords <- st_centroid(sprl) |>
  st_coordinates()
#> Warning in st_centroid.sf(sprl): st_centroid assumes attributes are constant
...
coords <- st_centroid(islands) |>
  st_coordinates()
#> Warning in st_centroid.sf(islands): st_centroid assumes attributes are constant
#> over geometries of x
...
<img src="outputs/smashing-tessellations-19766549.png" width="500px" />
