...
Simple features meets circle packing meets rayrendering meets Yayoi Kusama.
...
UPDATED to use color palettes from [Nicola Rennie's](https://github.com/nrennie) [{PrettyCols}](https://nrennie.github.io/PrettyCols/) package.

```{r echo=FALSE, out.width="500px"}
# Display image
knitr::include_graphics("2022-01-26_My-kid-could-have-done-that/outputs/meandering-paths-Bright-43039903.png")
```
...
```{r echo=FALSE, out.width="500px"}
# Display image
knitr::include_graphics("2022-01-27_Hilma-Af-Klint/outputs/hilda-af-klint-Casita1-26193853.png")
```

## Day 28: [Generative poetry](https://github.com/paezha/genuary2023/tree/master/2022-01-28_Generative-Poetry)

A poem by [Lady Ono no Komachi](https://en.wikipedia.org/wiki/Ono_no_Komachi) (c. 825 - c. 900) written in randomly generated asemic glyphs:
...
```{r echo=FALSE, out.width="500px"}
# Display image
knitr::include_graphics("2022-01-28_Generative-Poetry/outputs/asemic-poetry-70563873.png")
```

## Day 29: [Maximalism: _Pluribus unum Multorum chaos_](https://github.com/paezha/genuary2023/tree/master/2022-01-29_Maximalism)

For this prompt I looked into Chinese Maximalism, and the work of the work of [Xu Hongming](https://www.wikiart.org/en/xu-hongming). This piece (that I call _Pluribus unum Multorum chaos_) is inspired by Hongming's ["Human Condition One"](https://www.wikiart.org/en/xu-hongming/-1994) (人态一 : Rén tài yī)

```{r echo=FALSE, out.width="500px"}
# Display image
knitr::include_graphics("2022-01-29_Maximalism/outputs/pluribus-unum-multorum-chaos-20812715.png")
```
...
```{r echo=FALSE, out.width="500px"}
# Display image
knitr::include_graphics("2022-01-30_Minimalism/outputs/dunes-Maiz-37040510-50815853.png")
```

## Day 31: [Break a previous image](https://github.com/paezha/genuary2023/tree/master/2022-01-31_Break-a-previous-image)

For some reason I did quite some breaking during this Genuary, including [here](https://github.com/paezha/genuary2023/tree/master/2022-01-08_Signed-Distance-Functions), [here](https://github.com/paezha/genuary2023/tree/master/2022-01-12_Tessellation), and [here](https://github.com/paezha/genuary2023/tree/master/2022-01-29_Maximalism). For this prompt I break a previous image by "ubreaking" it. The image below is an unshattered version of the shattered voronoi polygons of Day 12.

UPDATED to use color palettes from [Nicola Rennie's](https://github.com/nrennie) [{PrettyCols}](https://nrennie.github.io/PrettyCols/) package.

```{r echo=FALSE, out.width="500px"}
# Display image
knitr::include_graphics("2022-01-31_Break-a-previous-image/outputs/unsmashed-tessellations-TangerineBlues-73279390.png")
```
