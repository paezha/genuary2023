...
Having never worked with sound before the best that I could do was use the notes of Bach's [Crab Canon](https://www.youtube.com/watch?v=36ykl2tJwZM) to choose the colors of the leaves of yesterday's [plants](https://github.com/paezha/genuary2023/tree/master/2022-01-09_Plants). 
...
# Display image
knitr::include_graphics(glue("outputs/crab-plant-{seed}.png"))
```
