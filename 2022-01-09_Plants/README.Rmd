...
if(color_edition == "MetBrewer"){
  ...
  col_palette_name <- sample(c("Blues", "Purples", "Tangerines", "Greens", "Pinks", "Teals", "PurpleGreens", "PinkGreens", "TangerineBlues", "PurplePinks", "TealGreens", "Bold", "Dark", "Light", "Neon", "Relax", "Autumn", "Winter", "Rainbow"), 1)
...
ggsave(filename = glue::glue("outputs/plant-{col_palette_name}-{seed}.png"),
       height = 7,
       width = 4)
```
...
# Display image
knitr::include_graphics(glue("outputs/plant-{col_palette_name}-{seed}.png"))
```
