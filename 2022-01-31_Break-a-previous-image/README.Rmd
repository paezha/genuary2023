...
```{r include=FALSE}
# Read named image
im <- imager::load.image(glue("outputs/unsmashed-tessellations-{seed}.png"))
```
...
```{r include=FALSE}
# Save cropped image
imager::save.image(im, file = glue("outputs/unsmashed-tessellations-{seed}.png"))
```

```{r echo=FALSE, out.width="500px"}
# Display image
knitr::include_graphics(glue("outputs/unsmashed-tessellations-{seed}.png"))
```
