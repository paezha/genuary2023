...
The sinuous meander paths of [David Chappelle](doi.org/10.1080/17513472.2015.1092859) may have been inspired by the mathematics used to represent the geomorphology of streams, but to me many of the outputs look like the awesome monsters that my son used to draw as a child.
...
Select the starting point of the meander and an index value. Use these to initialize a data frame. The angle ($theta$ or $\theta$) is the tangent of the meander at $t$ with respect to the x-axis (see Chappelle).
```{r}
